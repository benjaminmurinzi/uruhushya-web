...
<head>
    ...
    <title>Edit Question - URUHUSHYA Admin</title>
    <link rel="stylesheet" href="../assets/css/admin-dashboard.css">
</head>
<body>
    <!-- Sidebar (same as question-add.php) -->
    <aside class="sidebar">
    ...
    <main class="main-content">
        <header class="top-bar">
            <h1>Edit Question #<?php echo $question_id; ?></h1>
                ...
                <form method="POST" enctype="multipart/form-data" class="question-form">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            accept="image/*"
                        >
                        <small>Upload new image to replace current (JPG, PNG, GIF, WEBP)</small>
                    </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input 
                                    type="text" 
                                    name="option_a_rw" 
                                    value="<?php echo htmlspecialchars($question['option_a_rw']); ?>"
                                    required
                                >
                            </div>
                            <div class="form-group">
                                ...
                                <input 
                                    type="text" 
                                    name="option_a_en" 
                                    value="<?php echo htmlspecialchars($question['option_a_en']); ?>"
                                >
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input 
                                    type="text" 
                                    name="option_b_rw" 
                                    value="<?php echo htmlspecialchars($question['option_b_rw']); ?>"
                                    required
                                >
                            </div>
                            <div class="form-group">
                                ...
                                <input 
                                    type="text" 
                                    name="option_b_en" 
                                    value="<?php echo htmlspecialchars($question['option_b_en']); ?>"
                                >
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input 
                                    type="text" 
                                    name="option_c_rw" 
                                    value="<?php echo htmlspecialchars($question['option_c_rw']); ?>"
                                    required
                                >
                            </div>
                            <div class="form-group">
                                ...
                                <input 
                                    type="text" 
                                    name="option_c_en" 
                                    value="<?php echo htmlspecialchars($question['option_c_en']); ?>"
                                >
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input 
                                    type="text" 
                                    name="option_d_rw" 
                                    value="<?php echo htmlspecialchars($question['option_d_rw']); ?>"
                                    required
                                >
                            </div>
                            <div class="form-group">
                                ...
                                <input 
                                    type="text" 
                                    name="option_d_en" 
                                    value="<?php echo htmlspecialchars($question['option_d_en']); ?>"
                                >
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="category">
                                ...
                                <?php foreach ($categories as $cat): ?>
                                    <option value="<?php echo $cat; ?>" <?php echo $question['category'] === $cat ? 'selected' : ''; ?>>
                                        <?php echo $cat; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
