                                ...
                                <div class="plan-header">
                                    ...
                                    <div class="plan-duration">
                                        ...
                                        if ($plan['duration_days'] == 30) {
                                            ...
                                            echo 'For ' . $plan['duration_days'] . ' days';
                                        }
                                        ?>
                                    </div>
                                    
                                    <?php if ($plan['duration_days'] == 90): ?>
                                        <div style="background: #10B981; color: white; padding: 4px 12px; border-radius: 12px; font-size: 12px; font-weight: 600; margin-top: 8px; display: inline-block;">
                                            Save 33%
                                        </div>
                                    ...
                                    <?php elseif ($plan['duration_days'] == 365): ?>
                                        <div style="background: #F59E0B; color: white; padding: 4px 12px; border-radius: 12px; font-size: 12px; font-weight: 600; margin-top: 8px; display: inline-block;">
                                            Best Value
                                        </div>
                                    <?php endif; ?>
                                </div>
